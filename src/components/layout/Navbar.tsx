...
//           <a
//             href="#"
//             className="font-display text-xl lg:text-2xl font-semibold text-brand-800 tracking-tight"
//           >
//             {business.name}
//           </a>
...
//                 key={link.href}
//                 href={link.href}
//                 className="text-sm font-medium text-ink-secondary hover:text-brand-700 transition-colors"
//               >
//                 {link.label}
//               </a>
//             ))}
...
//                   setLangOpen(!langOpen);
//                 }}
//                 className="flex items-center gap-1.5 text-sm text-ink-secondary hover:text-brand-700 transition-colors px-2 py-1 rounded-lg hover:bg-brand-50"
//               >
//                 <span>{LOCALES[locale].flag}</span>
//                 <Icon name="chevron-down" className="w-3.5 h-3.5" />
//               </button>
...
//               setIsOpen(!isOpen);
//             }}
//             className="lg:hidden p-2 text-ink-secondary hover:text-brand-700 transition-colors"
//             aria-label="Toggle menu"
//           >
//             <Icon name={isOpen ? "x" : "menu"} className="w-6 h-6" />
//           </button>
